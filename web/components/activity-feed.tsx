...
function ProcessingLabel({ className }: { className?: string }) {
  return (
    <span className={`inline-flex items-center gap-2 ${className ?? ""}`}>
      <Loader2 className="h-3.5 w-3.5 shrink-0 animate-spin text-eco-primary/70" />
      <span className="font-sans text-body-md text-eco-foreground/65">
        Processing...
      </span>
    </span>
  );
...
function FailedLabel({ className }: { className?: string }) {
  return (
    <span
      className={`font-sans text-body-md text-eco-foreground/55 ${className ?? ""}`}
    >
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        {processing ? (
          <ProcessingLabel className="font-medium" />
        ) : failed ? (
          <FailedLabel className="font-medium" />
        ) : (
          <>
...
function LibraryGridCard({ item }: { item: Item }) {
  ...
  return (
    ...
    >
      <ItemThumbnail item={item} className="aspect-video w-full" />
