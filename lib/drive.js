...
function generateFileContent(item) {
  ...
  const yamlValue = (v) => (v === null || v === undefined || v === '') ? 'null' : v;
...
artifact_name: ${yamlValue(item.artifact_name)}
artifact_url: ${yamlValue(item.artifact_url)}
artifact_url_source: ${item.artifact_url ? yamlValue(item.artifact_url_source) : 'null'}
linked_resources: []
---
...
module.exports = { saveToGrimoire, appendLinkedResource, addLinkedResourceToFrontmatter, mergeLinkedResource, replaceTagInContent, resolveTagInFile };
