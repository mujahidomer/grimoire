...
Examples: "what are my main saved topics?", "how many Instagram saves do I have?", "who do I save most from?", "what did I save this month?", "what are the themes across my saves?", "which platform do I save from most?", "what are all the design skills I've saved?", "list every tool across my saves", "what are the themes of everything I saved?", "show me all recipes I've saved", "what skills appear most across my library?", "give me every X from all my links", "across all my saves, what...", "from all my saved links, list...", "what are the motion design skills I've saved?", "what design tools have I saved for animation?", "list the resources I have saved for [topic]", "what Claude skills do I have for [topic]?", "what are the [type] skills in [topic]?", "what do I have saved about [topic]?" when it implies listing items, "show me everything I saved about [topic]", "what have I saved related to [topic]?"
...
IMPORTANT: Any question asking to enumerate, list, or show saved items
of a specific type — even when scoped to a topic — is JOB_B, not JOB_A.
The difference:
- "what is GSAP?" → JOB_A (explain a concept)
- "what GSAP resources have I saved?" → JOB_B (list items from library)
- "what are the motion design skills in my saves?" → JOB_B (enumerate saved items)
- "what do I know about motion design?" → JOB_A (synthesise knowledge)
