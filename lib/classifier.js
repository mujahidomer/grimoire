...
Analyze the content and decide what structure best captures its essence.
Output keyTakeaways as a JSON object with keys you invent based on what
this specific content actually contains. Do not use a fixed schema or
template. The keys and structure should feel obvious to someone who just
read this content. Values can be strings, arrays of strings, or nested
objects — whatever fits. No flat generic bullet lists.
