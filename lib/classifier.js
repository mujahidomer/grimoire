...
const { TOP_CATEGORIES, DEFAULT_SUBCATEGORY, normalizeTopCategory, normalizeSubcategoryLabel } = require('./topCategories');
...

{
  ...
  "top_category": "exactly one of: ${TOP_CATEGORIES.join(' | ')} — NEVER any other value, never invent a new top-level category",
  "category": "the specific topic shelf this belongs on WITHIN top_category — a short Title Case label, 1-3 words (e.g. 'Prompt Engineering' under Technology & AI, 'Duas' under Religion & Spirituality, 'Desserts' under Food & Cooking). Prefer a broadly reusable topic label over a hyper-specific one.",
