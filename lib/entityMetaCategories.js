...
const META_CATEGORIES = {
  ...
  // The Islamic entity types share one shelf. Unlike the four types above there
  // is nothing to choose between — a supplication, a level of the nafs and a
  // Qur'anic verse all belong under the same heading — so each list is
  // deliberately length 1, and resolveMetaCategory short-circuits on that.
  //
  ...
  // 'Islamic Knowledge'. It does not get a meta_category of its own. Settled,
  // not a question to re-derive.
  dua: ['Islamic Knowledge'],
  islamic_concept: ['Islamic Knowledge'],
  quranic_verse: ['Islamic Knowledge'],
};
